...
txt_path = './queries/queries_bus_new.txt' #Name and directory of the .txt queries generated by the code
video_name= 'queries_bus_new' #Name of the video queries generated by the code
...
tresh = 2*np.amin(np.array(L))/np.amax(np.array(L)) #treshold : positive or negative.
