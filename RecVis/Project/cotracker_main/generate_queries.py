...
txt_path = './queries/queries_bus.txt' #Name and directory of the .txt queries generated by the code
video_name= 'queries_bus' #Name of the video queries generated by the code
vid_path = "./videos/"+video_name+".mp4" #Directory of the video queries generated by the code
...
tresh = 2*np.amin(np.array(L))/np.amax(np.array(L))
...
nom=txt_path     #on crée une variable de type string
...
path_show = os.path.abspath(vid_path)
